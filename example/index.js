(function () {
	...
	*******************************************************************************/
	...
	Reducer
	*******************************************************************************/
	function suggestionsBoxReducer(state, action) {
	  switch (action.type) {
	    case 'input':
	      var isShown = true;
	...
	function classNames(classNameMap) {
	  var classStr = '';
	...
	function SuggestionsBox({
	  ...
	  return isShown && /*#__PURE__*/React.createElement("div", {
	    className: "autocomplete_suggestions-box",
	...
	function AutocompleteInput({
	  ...
	  const [autocompleter, dispatchForAutocompleter] = react.exports.useReducer(autocompleterReducer, {
	    value,
	    hiddenValue: value,
	    data,
	    getInputValue,
	  ...
	  const [suggestionsBox, dispatchForSuggestionsBox] = react.exports.useReducer(suggestionsBoxReducer, {
	    entrySelected: -1,
	    isShown: false,
	    suggestions: data,
	    allOnEmpty,
